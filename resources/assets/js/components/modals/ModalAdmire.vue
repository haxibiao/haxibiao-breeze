                ...
                <div class="modal-body">
                        ...
                        <div class="main-inputs">
                            <div class="amount-group">
                                ...
                                <label for="option1" class="option" @click="selectMoney"
                                    ><i class="iconfont icon-jinqian1"></i> <span class="amount">2</span>
                                    <span class="piece">元</span></label
                                >
                                <input id="option2" type="radio" value="5" v-model="money" />
                                <label for="option2" class="option hidden-xs" @click="selectMoney"
                                    ><i class="iconfont icon-jinqian1"></i> <span class="amount">5</span>
                                    <span class="piece">元</span></label
                                >
                                <input id="option3" type="radio" value="10" v-model="money" />
                                <label for="option3" class="option" @click="selectMoney"
                                    ><i class="iconfont icon-jinqian1"></i> <span class="amount">10</span>
                                    <span class="piece">元</span></label
                                >
                                <input id="option4" type="radio" value="20" v-model="money" />
                                <label for="option4" class="option hidden-xs" @click="selectMoney"
                                    ><i class="iconfont icon-jinqian1"></i> <span class="amount">20</span>
                                    <span class="piece">元</span></label
                                >
                                <input id="option5" type="radio" value="50" v-model="money" />
                                <label for="option5" class="option" @click="selectMoney"
                                    ><i class="iconfont icon-jinqian1"></i> <span class="amount">50</span>
                                    <span class="piece">元</span></label
                                >
                                <input
                                    id="custom-option"
                                    ...
                                    :checked="custom"
                                />
                                <label for="custom-option" class="option" @click="customMoney"
                                    ...
                                    <div class="custom-amount-input">
                                        ...
                                        <input
                                            ...
                                            ref="customInput"
                                        />
                                        <span class="piece hidden-xs">元</span>
                                    </div>
                                </label>
                            </div>
                            <div class="message">
                    ...
                    <div v-show="wexinPay" class="wx-qr-code">
                        ...
                        <div class="qr-code" title="">
                            <img alt="Scan me!" src="/qrcode/tip.jpg" />
                        </div>
                        <div class="pay-amount">
                            赞赏金额:<span>￥{{ money }}</span>
                        </div>
                    </div>
                </div>
