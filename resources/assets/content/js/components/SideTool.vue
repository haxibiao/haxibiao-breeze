    ...
    <ul v-if="id ? true : isArticle">
        ...
        <template v-if="id">
            <li
                ...
                data-title="文章投稿"
            >
                <a class="js-submit-button" data-target=".modal-category-contribute" data-toggle="modal"
            ...
            <li
                ...
                data-title="將文章加入專題"
            >
                <a class="submit-button" data-target=".modal-add-category" data-toggle="modal"
            ...
            <li
                ...
                data-toggle="tooltip"
                data-container="body"
                :data-title="favorited ? '取消收藏文章' : '收藏该文章'"
                @click="toggle"
            >
                <a class="function_button"
