 <div class="note-info info-lg">
    ...
    <div class="title">
        ...
        @if($user->is_editor)
          <img class="badge-icon hidden-md hidden-sm hidden-lg" src="https://diudie-1251052432.cos.ap-guangzhou.myqcloud.com/images/signed.png" data-toggle="tooltip" data-placement="top" title="{{ seo_site_name() }}签约作者" alt="">
        @endif
    </div>
