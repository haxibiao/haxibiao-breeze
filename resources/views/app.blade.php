  ...
  <div class="container-fluid apps">
    <div class="row">
        <div class="container top-part">
          ...
          <img class="background-img" src="https://diudie-1251052432.cos.ap-guangzhou.myqcloud.com/web/public/images/app/appBackground.png" alt="app background">
          ...
          <div class="download-phone">
            ...
            <img src="https://diudie-1251052432.cos.ap-guangzhou.myqcloud.com/web/public/images/app/android_app.png"  onclick="download_btn()" class="download2" alt="download-andorid">



            <a href="{{ aso_value('下载页','苹果地址') }}"><img src="https://diudie-1251052432.cos.ap-guangzhou.myqcloud.com/web/public/images/app/ios_app.png" class="download2" alt="download-ios"></a>
            <img class="background-img" src="https://diudie-1251052432.cos.ap-guangzhou.myqcloud.com/web/public/images/app/appBackground.png" alt="Misc background">
