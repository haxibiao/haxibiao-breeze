...
<div id="mask" style="position:fixed; z-index:999999999999; top: 0; width: 100%; height: 100%; background: rgba(102, 102, 102, 0.5); display: none;">
    <div style="position:absolute; width: 100%; height: 100%;">
        ...
        <span style="color: #FFFFFF; width:70%; font-size: 15px; margin: 5% 30% 0 5%; position: relative; top: 30px; left:10%;">点击右上角按钮，然后在弹出的菜单中<br />点击
            "用浏览器打开" 后再下载安装。</span>
    </div>
</div>
...
<div class="container-fluid apps">
    <div class="row">
        <div class="container top-part">
            ...
            <img id="tancen" class="phone-img" src="{{ aso_value('功能介绍1图') }}" alt="app phone">
    ...
    <div class="row">
        <div class="container middle-part">
            <div class="col-sm-12 col-sm-offset-2 text-block">
                <h3>{!! aso_value('功能介绍1标题') !!}</h3>
                <h6>{!! aso_value('功能介绍1文字') !!}</h6>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="container middle-part">
            <div class="col-sm-5 col-sm-offset-1"><img src="{{ aso_value('功能介绍2图') }}" alt="Misc pic2"></div>
            <div class="col-sm-5 col-sm-offset-1 text-block">
                <h3>{!! aso_value('功能介绍2标题') !!}</h3>
                <h6>{!! aso_value('功能介绍2文字') !!}</h6>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="container middle-part">
            <div class="col-sm-5 col-sm-offset-1 text-block">
                <h3>{!! aso_value('功能介绍3标题') !!}</h3>
                <h6>{!! aso_value('功能介绍3文字') !!}</h6>
            </div>
            <div class="col-sm-5 col-sm-offset-1"><img src="{{ aso_value('功能介绍3图') }}" alt="Misc pic3"></div>
        </div>
    </div>
    <div class="row">
        <div class="container middle-part">
            <div class="col-sm-5 col-sm-offset-1"><img src="{{ aso_value('功能介绍4图') }}" alt="Misc pic4"></div>
            <div class="col-sm-5 col-sm-offset-1 text-block">
                <h3>{!! aso_value('功能介绍4标题') !!}</h3>
                <h6>{!! aso_value('功能介绍4文字') !!}</h6>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="container bottom-part">
            ...
            <div class="download-phone">
                <div class="download-platform">
                    @if (isRobot())
                    <a href="{{ aso_value('安卓地址') }}"><img src="/images/app/android_app.png" class="download2" alt="download-andorid"></a>
                    @else
                    <div class="download2">
                        <img src="/images/app/android_app.png" onclick="download_btn()" alt="download-andorid">
                        <p onclick="show_more_version()"> 版本记录</p>
